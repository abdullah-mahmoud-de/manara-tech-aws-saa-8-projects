...
# Private Subnets (For EC2 Compute)
resource "aws_subnet" "private_compute" {
  count             = 2
  vpc_id            = aws_vpc.main.id
  cidr_block        = cidrsubnet(var.vpc_cidr, 8, count.index + 2)
  availability_zone = data.aws_availability_zones.available.names[count.index]
  tags = { Name = "${var.project_name}-private-compute-${count.index + 1}" }
}
...
# ==========================================
# 3. IAM ROLE FOR SYSTEMS MANAGER (SSM)
# ==========================================
...
# ==========================================
# 5. COMPUTE & SCALING (ALB, ASG, Launch Template)
# ==========================================
resource "aws_lb" "alb" {
